...
namespace Microsoft.AspNetCore.Server.Kestrel.Core.Internal.Http3
{
    internal abstract class Http3ControlStream : IThreadPoolWorkItem
    {
        ...
        private void OnClientGoAway(long lastProcessedStreamId)
        {
            ...
            // TODO indicate to http3connection to stop accepting streams
            ...
            lock (_http3Connection._sync)
            {
                ...
                foreach (KeyValuePair<long, Http3Stream> request in _http3Connection._streams)
                {
                ...
                // TODO anything to do to shutdown the connection?
                //CheckForShutdown();
            }
